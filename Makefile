...
OBJS_MAIN = $(addprefix $(OBJS_PATH), $(notdir $(SRCS_MAIN:.c=.o)))

# ============================= FORMATTING VARS ============================== #

# counting files vars
TOTAL			:= $(words $(SRCS) $(SRCS_MAIN))
FILE_COUNT		:= 0
...
$(NAME): $(OBJS) $(OBJS_MAIN) libft ft_printf
#	==================== draw progress bar ===================
...
#	================= write rest of messages =================
	...
	@$(CC) $(CFLAGS) -o $(NAME) $(OBJS) $(OBJS_MAIN) -LLibft -lft -Lft_printf -lftprintf
...
bonus: $(OBJS_BONUS) $(OBJS) libft ft_printf
	$(CC) $(CFLAGS) -o $(NAME_BONUS) $(OBJS) $(OBJS_BONUS) -LLibft -lft -Lft_printf -lftprintf 
...
.PHONY:  all clean fclean re ft_printf libft bonus